...
class Intention(nn.Module):
    ...
    def __init__(self, dim, num_heads, kqv_bias=False, device='cuda:7'):
...
class IntentionBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads=8, kqv_bias=True, device='cuda:7'):
...
class BiIntention(nn.Module):
    def __init__(self, embed_dim, layer=1, num_head=8, device = 'cuda:7'):
